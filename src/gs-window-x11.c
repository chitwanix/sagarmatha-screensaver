...
popup_dialog (GSWindow *window)
{
        ...
        tmp = g_build_filename (LIBEXECDIR, "sagarmatha-screensaver-dialog", NULL);
...
gs_window_init (GSWindow *window)
{
        ...
        // Default message        
        window->priv->default_message = g_settings_get_string(g_settings_new ("org.sagarmatha.screensaver"), "default-message");
