...
#include "sagarmatha-screensaver.h"
#include "gs-monitor.h"
#include "gs-debug.h"

void
sagarmatha_screensaver_quit (void)
{
        gtk_main_quit ();
}
...
# endif
        ...
        gs_debug ("initializing sagarmatha-screensaver %s", VERSION);
        ...
        gs_debug ("sagarmatha-screensaver finished");
